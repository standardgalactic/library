...
Concavity of $g_m$ and penalties $\chi(n)$ and $(1 + \rho \Sent)^{-1}$ make \eqref{eq:objective} subadditive. Concentrating $A$ increases $\sigma_m$ while limiting $\Sent$ growth. The $L^p$ penalty with $p < 1$ promotes sparsity.
\end{proof}
\end{proposition>
