#!/usr/bin/env python3
"""
A script to extract plain text from PDF, EPUB, MHTML, and Markdown files.

Usage:
    python extract_text.py file1.pdf file2.epub file3.md
    python extract_text.py                 # processes all supported files in current dir
    ...
    try:
        ...
        if msg.is_multipart():
            for part in msg.walk():
                ...
                if ctype == 'text/html':
                    soup = BeautifulSoup(decode_part(part), 'html.parser')
...
def process_directory(directory):
    for filename in os.listdir(directory):
        if filename.lower().endswith((".pdf", ".epub", ".mhtml", ".mht", ".md")):
